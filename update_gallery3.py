    ...
    html = f"""
        <div class="gallery-tile" data-category="photo">
          <div class="gallery-tile-placeholder">
            <img src="assets/{img}" alt="Queen Delila Gallery" style="width:100%; height:auto; display:block; border-radius:inherit;">
          </div>
...
for vid in videos:
    ...
    html = f"""
        <div class="gallery-tile gallery-tile--video" data-category="video">
          <div class="gallery-tile-placeholder">
            <video loop muted playsinline autoplay style="width:100%; height:auto; display:block; border-radius:inherit;">
...
new_content = re.sub(r'(<div class="gallery-grid">).*?(      </div>\s*</div>\s*</section>)', r'\g<1>\n' + gallery_html + r'\n\g<2>', content, flags=re.DOTALL)

with open('gallery.html', 'w', encoding='utf-8') as f:
    f.write(new_content)

print('Updated gallery.html with', len(gallery_items), 'items mixed and masonry styled.')
